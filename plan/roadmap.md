...
#### 6c. New-page opportunity engine (grounded in real demand, ruthless dedup)
...
#### 6d. Wikidata entity layer (skip the vanity, keep the 3 that compute)
...
#### 6e. Unified priority model — switch to Expected Clicks / Dev-Hour (yield, not points)
