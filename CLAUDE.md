...
- `src/audit/checks.ts` + `engine.ts` — **~51 checks** (priority via the 6e yield model: `(T × Y × C) / E` = expected clicks per dev-hour); 6b per-template: `pagination-canonical-to-page-1`, `article-date-illogical`
